const sprite = {
    ...
    'quip': `
        <title />
        <path fill-rule="evenodd" clip-rule="evenodd" d="M19.1 17.9l-1.2 1.2c-.1.1-.4.1-.5 0L12 13.7V12h1.7l1.6 1.6V8.7H8.7v6.6H12l2.4 2.4H7.1c-.5 0-.8-.3-.8-.8V7.1c0-.5.3-.8.8-.8h9.8c.5 0 .9.3.9.8V16l1.3 1.4c.1.1.1.4 0 .5z" />
    `,
    'quip_sheet': `
...
window.$Icons.addSprite('standard', sprite);
