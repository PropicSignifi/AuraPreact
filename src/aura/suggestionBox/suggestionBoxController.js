({
    init: function(component, event, helper) {
        ...
        if (!label || label.length === 0) {
            $A.warning('Invalid `label` attribute for <c:suggestionBox> component.' + 'The `label` attribute is required, E.g.: <c:suggestionBox label="Resume" value="" />');
        }
    ...
    onClearItem: function(component, event, helper) {
        helper.onClearItem(component, event);
    },
